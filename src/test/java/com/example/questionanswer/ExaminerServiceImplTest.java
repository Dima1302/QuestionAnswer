...
import com.example.questionanswer.service.ExaminerServiceImpl;
...
public class ExaminerServiceImplTest {
    ...
    public void getQuestionsNegativeTest(int incorrectAmount) {
        assertThatExceptionOfType(LargeNumberOfQuestions.class).isThrownBy(()->examinerService.getQuestions(incorrectAmount));
    }
...
public void getQuestionsTest() {
    ...
    assertThat(examinerService.getQuestions(4))
            .containsExactly(questions.get(0),questions.get(1),questions.get(2),questions.get(3));
